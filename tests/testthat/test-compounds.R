...
if (doSIRIUS)
{
    compsSIR <- generateCompounds(fGroups, plists, "sirius", logPath = NULL)
    compsSIREmpty <- generateCompounds(fGroupsEmpty, plistsEmpty, "sirius", logPath = NULL)
    compsSIREmptyPL <- generateCompounds(fGroups, plistsEmpty, "sirius", logPath = NULL)
}
...
test_that("verify SIRIUS compound generation", {
    ...
    expect_length(generateCompounds(fGroups, plistsEmptyMS, "sirius", logPath = NULL), 0)
})
